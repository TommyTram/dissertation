...
\paperauthor{Hannes~Eriksson, Tommy~Tram, Debabrota Basu, Jonas Sj\"oberg, and Christos~Dimitrakakis}

% \paperinfo[short info]{full info}
\paperinfo[\textit{Artificial Intelligence and Statistics 2023~(AISTATS)}]{
    \textit{Artificial Intelligence and Statistics 2023~(AISTATS)},\\
	pp. 3169--3174, Nov. 2023.\\
	\copyright 2018 IEEE DOI: 10.1109/ITSC.2018.8569316.
}

% \papertitle[short title]{full title}
\papertitle[Maximum Likelihood Estimation for Transfer Reinforcement Learning Problems in Autonomous Driving]{Maximum Likelihood Estimation for Transfer Reinforcement Learning Problems in Autonomous Driving}
