...
\tommy{what do I want to say about figure \ref{fig:zones}? This is an example of a discretized }

\begin{figure}[t]\label{fig:zones}
	\mbox{\parbox{\textwidth}{
		\centering
		\begin{tikzpicture}
			\def\xstart{-7};
    	...
    	% 	minimum height = 2cm] 
			...
			% \fill [orange] (-1,-1) rectangle (-3.5,1);
			% \fill [gray] (-3.5,1) rectangle (\xstart,-1);

			% \node[xshift=0 cm,draw,minimum height=1cm,minimum width=\w cm,anchor=west,outer sep=0pt]{\n};
